...
public class MinSpanningTreePrimTest extends ApplicationTest {
	...
	public void graphTest1() {
		...
		MinSpanningTreePrim a = new MinSpanningTreePrim(workspace.getGraph());
